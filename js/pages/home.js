...
export const HomePage = () => {
    ...
    return `
        ...
        <section id="services-section" class="py-20">
            <div class="container mx-auto px-6">
                <div class="text-center mb-12 animated-section">
                    <h2 class="text-3xl md:text-4xl font-bold font-heading">Nuestros Servicios</h2>
                    <p class="text-gray-600 mt-2">Soluciones diseñadas para impulsar tu negocio.</p>
                </div>
        ...
        <section id="benefits-section" class="py-20 bg-nodica-gray">
            <div class="container mx-auto px-6">
                <div class="text-center mb-12 animated-section">
